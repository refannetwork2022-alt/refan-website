        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-64 h-64 rounded-2xl overflow-hidden mb-6 shadow-elevated border-4 border-white">
              <img src="/founder-goreth.jpg" alt="Général Secretary Goreth Niyibigira" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-64 h-64 rounded-2xl overflow-hidden mb-6 shadow-elevated border-4 border-white">
              <img src="/founder-wagstan.jpg" alt="Président Lydia Igirajeza" className="w-full h-full object-cover" />
            </div>
