        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="aspect-[3/2] rounded-xl overflow-hidden shadow-elevated border-4 border-primary/20">
              <img src="/founder_1.jpg" alt="Founder & Chairman" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-64 h-64 rounded-2xl overflow-hidden mb-6 shadow-elevated border-4 border-white">
              <img src="/Goreth Niyibigira - Président.jpg" alt="Président Goreth Niyibigira" className="w-full h-full object-cover" />
            </div>
